...
from ops$u2970.sec_segments p join PVMGT_GNs_DCMI_RP lb 
on p.corridor_code_rb=lb.corridor_code_rb and p.beg_gn=lb.gn_id
join PVMGT_GNs_DCMI_RP le on p.corridor_code_rb=le.corridor_code_rb 
